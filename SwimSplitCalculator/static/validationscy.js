function selectdist() {
    ...
    if(value == "fly" || value == "back" || value == "breast")
    {
        ...
        document.getElementById('500l').style.display = 'none';
        document.getElementById('1000l').style.display = 'none';
        document.getElementById('1650l').style.display = 'none';
    }
    else if(value == "free")
    {   
        var ele = document.getElementsByName("distance");
        ...
        document.getElementById('200l').style.display = 'block';
        document.getElementById('400l').style.display = 'none';
        document.getElementById('500l').style.display = 'block';
        document.getElementById('1000l').style.display = 'block';
        document.getElementById('1650l').style.display = 'block';
    }
    else if(value == "im")
    {
        var ele = document.getElementsByName("distance");
        ...
        document.getElementById('200l').style.display = 'block';
        document.getElementById('400l').style.display = 'block';
        ocument.getElementById('500l').style.display = 'block';
        document.getElementById('1000l').style.display = 'block';
        document.getElementById('1650l').style.display = 'block';
    }
    enableSubmit();
